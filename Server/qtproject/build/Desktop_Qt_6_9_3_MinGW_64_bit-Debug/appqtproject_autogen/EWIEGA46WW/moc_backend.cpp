...
template <> constexpr inline auto Backend::qt_create_metaobjectdata<qt_meta_tag_ZN7BackendE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'llmSummaryReady'
        QtMocHelpers::SignalData<void(const QString &)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 9 },
        }}),
        // Slot 'onMqttMessageReceived'
        QtMocHelpers::SlotData<void(const QByteArray &, const QMqttTopicName &)>(10, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QByteArray, 11 }, { 0x80000000 | 12, 13 },
        }}),
...
void Backend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->llmSummaryReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 6: _t->onMqttMessageReceived((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QMqttTopicName>>(_a[2]))); break;
        ...
        case 9: _t->updateData((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        case 10: _t->startVoiceCommand(); break;
        case 11: _t->relaunchApp(); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (Backend::*)()>(_a, &Backend::currentTimeChanged, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (Backend::*)(const QString & )>(_a, &Backend::llmSummaryReady, 5))
            return;
    }
...
// SIGNAL 5
void Backend::llmSummaryReady(const QString & _t1)
{
