...
Item {
    ...
    */
        ...
        property var refPoints: [
            { world: Qt.point(2.33, -0.9), img: Qt.point(31, 29) },     //좌상단
            { world: Qt.point(-5.357, -2.97), img: Qt.point(1295, 29) },   //우상단
            { world: Qt.point(1.59, 1.785), img: Qt.point(31, 512) },   //좌하단
            { world: Qt.point(-6.168, -0.2637), img: Qt.point(1295, 512) }  //우하단
        ]
